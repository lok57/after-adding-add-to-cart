                        ...
                        <>
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            <button 
                              ...
                              className="flex items-center justify-center space-x-2 border border-black dark:border-white text-black dark:text-white px-6 py-3 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                            >
                              <ShoppingBag className="h-5 w-5" />
                    ...
                    <form onSubmit={handleAddToWaitlist} className="space-y-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-black focus:border-transparent dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                      ...
                      <button
                        ...
                        className="w-full border border-gray-300 dark:border-gray-600 px-6 py-3 rounded-full hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
                      >
                        Cancel
                      </button>
                    </form>
